export default function About() {
  return (
    <section className="flex-none gap-8 bg-[url('greenlandscape-full.jpg')] bg-cover bg-center bg-no-repeat pb-32 pt-20 text-white md:px-10 xl:flex xl:items-center xl:justify-center xl:bg-none xl:text-dark-green">
      <div className="rounded-xl border-2 border-white/40 p-10 shadow-xl backdrop-blur-md xl:w-1/2 xl:border-none xl:text-dark-green xl:shadow-none">
        ...
        <p className="mb-6 text-justify text-sm md:text-base">
          <span className="font-semibold">Next Level Life</span> was designed to
          help individuals take their dreams and break them down into
          something actionable. This provides people with a much clearer
          understanding of their goals and the steps needed to achieve them! When
          you allow your heart and desires to govern the creative process
          without holding back, it becomes easier for that vision to inherently
          influence your day-to-day decisions.
        </p>
      </div>
      <div className="w-1/3">
        <img
