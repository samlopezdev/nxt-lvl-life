...
## Optimizations
- [ ] Enhance the Profile page by incorporating further details about the app's functionality.
- [ ] Enable users to add more than just images to their panels. Giving them the freedom to upload videos, text, or link to web pages could be super beneficial to a users experience.
- [ ] Add lightbox of some way to click on the images without taking them directly to the link.
